        ...
        <div class="col px-5">
            ...
            <div class="">
                <form action="convert" method="POST" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-md-2">
                        <label for="Semester" class="form-label">Semester</label>
                        <select class="form-select" id="Semester" name="Semester" onchange="expoty(this.value)"
                            required>
                            <option selected disabled value="">Choose...</option>
                            <option value="SEM1">SEM1</option>
                            <option value="SEM2">SEM2</option>
                    ...
                    <div class="col-md-5">
                        <label for="Course" class="form-label">Course</label>
                        <select class="form-select" id="export" name="Course" required>
                            <option selected disabled value="">Choose...</option>
                        </select>
                        <div class="invalid-feedback">
                            Please select a Course.
...
<script>
    ...
    function expoty(data) {
        ...
        sem.onreadystatechange = function () {
            if (sem.readyState == 4 && sem.status == 200) {
                document.getElementById('export').innerHTML = sem.responseText;
            }
        }
    }
</script>
