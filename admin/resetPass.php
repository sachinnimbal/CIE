                            ...
                            if(mysqli_stmt_num_rows($stmt) == 1){                    
                                ...
                                if(mysqli_stmt_fetch($stmt)){
                                    if(password_verify($password, $hashed_password)){
                                        ...
                                        <strong>Invalid username, role or password. </strong>
            ...
            <form action="" method="POST" class="row g-3 needs-validation" novalidate>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="Faculty_rold" disabled name="Faculty_rold" required <?php if ($status == 1) { echo ''; }else { echo 'disabled'; } ?>>
