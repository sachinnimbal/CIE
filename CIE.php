        ...
        <div class="col px-5">
            ...
            <div class="">
                ...
                if (isset($_POST['studentBatch']) && isset($_POST['Semester']) && isset($_POST['Course'])) {
                    ...
                    if($result_Student = mysqli_query($conn, $check)){
                        if(mysqli_num_rows($result_Student) > 0){
                            $counter = 0;
                            ?>
                <form action="./Query/U_cie_update.php?batch=<?= htmlspecialchars($Get_Bat) ?>" method="post" class="needs-validation" novalidate>
                    <table class="table">
                        <tr>
                ...
                <?php
                            ...
                            ?>
                <form action="./Query/U_cie_add.php?batch=<?= htmlspecialchars($Get_Bat) ?>" method="post">
                    <table class="table">
                        <tr>
                            <td class="text-end">Batch :</td>
                            <td class="text-start fw-bold">
